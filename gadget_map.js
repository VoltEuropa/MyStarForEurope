...
(function (window, rJS, RSVP, L) {
  ...
  var DICT = {};
  var STR = "";
  var MAP_URL = 'https://stamen-tiles-{s}.a.ssl.fastly.net/toner/{z}/{x}/{y}{r}.{ext}';
  var MAP_CONFIG = {
  ...
  var DEFAULT_POSITION = [54.5260, 15.2551];
  var DEFAULT_ZOOM = 5;
  ...
  rJS(window)
    ...
    .declareMethod("renderMap", function () {
      var gadget = this;
      var dict = gadget.property_dict;
      var queue = new RSVP.Queue();
      ...
      return queue
        .push(function () {
          return gadget.setMarkerContent("marker_template", STR);
        })
        .push(function (my_marker_content_dict) {
          if (dict.marker_layer) {
            dict.map.removeLayer(dict.marker_layer);
          }
          dict.map.setView(my_marker_content_dict.position || DEFAULT_POSITION, dict.config.zoom || DEFAULT_ZOOM);
